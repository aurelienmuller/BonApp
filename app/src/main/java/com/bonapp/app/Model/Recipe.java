...
//correspond to the Recipe table from the database
//all attributes are from the food2fork API
//we only use title, recipe_id and source_url but the rest could be useful in case of future modifications
